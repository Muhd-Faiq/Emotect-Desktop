...
class manageUserPage(Frame):
    ...
    def showTable(self):
        ...
        self.my_game['columns'] = ('player_Name', 'player_Email', 'player_Role')
        ...
        self.my_game.column("player_Role",anchor=CENTER,width=120)
        ...
        self.my_game.heading("player_Role",text="Role",anchor=CENTER)
        ...
        self.playerrole = Label(self.frame2,text="Player_role")
        self.playerrole.grid(row=0,column=2)
        ...
        self.playerrole_entry = Entry(self.frame2)
        self.playerrole_entry.grid(row=1,column=2,ipadx=30)
        ...
        def select_record():
            ...
            self.playerrole_entry.delete(0,END)
            ...
            self.playerrole_entry.insert(0,values[2])

        #save Record
        def update_record():
            selected=self.my_game.focus()
            #save new data 
            self.my_game.item(selected,text="",values=(self.playername_entry.get(),self.playeremail_entry.get(),self.playerrole_entry.get()))
